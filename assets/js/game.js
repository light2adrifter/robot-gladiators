...
var enemyNames = ["Zero", "Omega", "Sigma"];
var enemyHealth = 50;
var enemyAttack = 12;
...
var fight = function(enemyName) {
    ...
    if (enemyHealth <= 0) {
        window.alert(enemyName + " has ceased functioning!");
    }
    else {
    ...
    if (playerHealth <= 0) {
        window.alert(playerName + " has ceased functioning!");
    }
...
// If player chooses to skip
    ...
    // if yes (true), leave fight for -2 money
    if (confirmSkip) {
